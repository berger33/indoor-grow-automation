...
| 04 | `REV-A-04_PLANTA_BAIXA_RACK.svg` | mecânica | tanques, contenção e extração frontal | dimensões reais dos tanques |
| 05 | `REV-A-05_ELEVACAO_PAINEL_COMPACTO.svg` | mecânica | disposição vertical dos módulos | amostras e suportes medidos |
...
O rack ocupa envelope-alvo de 1.200 × 600 mm, ao lado da tenda de 800 × 800
mm, com faixa frontal mínima de 900 mm. A planta não fixa a posição definitiva
do ponto 127 V nem do dreno: ambos dependem do levantamento do local.

## Planta baixa

![Planta baixa do rack](../../../desenhos/REV-A-04_PLANTA_BAIXA_RACK.svg)

A contenção proposta recebe os dois tanques lado a lado. O envelope de cada
tanque foi limitado provisoriamente a 500 × 400 mm para preservar folga entre
plataformas e permitir extração independente.
...
esquerda, seis recipientes em duas fileiras à direita, hidráulica no centro e
reservatórios na base. Eletrônica e fluido permanecem segregados.
...
ficam no lado molhado. Cruzamentos inevitáveis são perpendiculares e protegidos.

## Critérios para revisão A1

- levantamento dimensional assinado, com fotos e croqui do ambiente;
- massa/carga do rack e ancoragem verificadas;
- dimensões dos recipientes e curso de retirada confirmados;
